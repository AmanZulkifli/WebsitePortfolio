            ...
            <section class="s-pagecontent pagecontent">
                    ...
                    <div class="row pageintro">
                        <div class="column xl-6 lg-12">
                            <h2 class="text-display-title">Tak kenal maka tak sayang</h2>
                        </div>
                        <div class="column xl-6 lg-12 u-flexitem-x-right">
                            <p class="lead">
                                Tak kenal maka tak sayang, tak sayang maka tak cinta, bukankah begitu sebagaimana mestinya? Saya
                                sendiri adalah orang yang cukup terbuka dalam topik pembicaraan. So, feel free to contact me!
                            </p>
                        </div>                       
                    </div> <!-- pageintro -->   
                    ...
                    <div class="row pagemedia">
                        <d class="column xl-12">
                            <figure class="page-media">                                
                                <img src="../assets/img/kontak-1200.jpg" 
                                    srcset="../assets/img/kontak-2400.jpg 2400w, 
                                            ../assets/img/kontak-1200.jpg 1200w, 
                                            ../assets/img/kontak-600.jpg 600w" sizes="(max-width: 2400px) 100vw, 2400px" alt="">
                            </figure>
                        </d>
                    </div> <!-- pagemedia --> 
                        ...
                        <div class="column xl-12">
                            ...
                            <div class="row">
                                <div class="column xl-6 md-12 contact-cta">     
                                    <p>
                                        Dunia ini kecil dan bundar, saya yakin pasti kita akan bertemu di suatu tempat suatu hari nanti, atau mungkin sudah pernah?
                                        hidup ini memang unik.
                                        Selain yang ada disini, saya yakin masih banyak hal dari diri saya yang masih akan membuat tertarik diri anda.
                                        Anda hanya belum mengetahuinya saja, penasaran? kontak saya sekarang!
                                    </p>
        
                                    <a href="mailto:amans172007@gmail.com" class="btn btn--primary u-fullwidth contact-btn">
                                ...
                                <div class="column xl-5 md-12 u-flexitem-x-right">
                                    ...
                                    <div class="contact-block">
                                        <h6>Email</h6>
                                        <a href="mailto:#0">Amans172007@gmail.com</a>
                                    </div>

                                    <div class="contact-block">
                                        <h6>Telepon</h6>
                                        <ul class="contact-list">
                                            <li><a href="tel:197-123-9876">+62 877 8563 1233</a></li>
                                        </ul>
                                    </div>
